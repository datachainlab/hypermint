...
func (_Token *MockToken) GetBalance(opts *bind.TransactOpts) (int64, error) {
	ret := _Token.Called()
	return ret.Get(0).(int64), ret.Error(1)
}

func (_Token *MockToken) Transfer(opts *bind.TransactOpts, to common.Address, amount int64) (*bind.SyncResult, error) {
	ret := _Token.Called(to, amount)
	return ret.Get(0).(*bind.SyncResult), ret.Error(1)
}

func (_Token *MockToken) TransferCommit(opts *bind.TransactOpts, to common.Address, amount int64) (*bind.CommitResult, error) {
	ret := _Token.Called(to, amount)
	return ret.Get(0).(*bind.CommitResult), ret.Error(1)
}

func (_Token *MockToken) Init(opts *bind.TransactOpts) (*bind.SyncResult, error) {
	ret := _Token.Called()
	return ret.Get(0).(*bind.SyncResult), ret.Error(1)
}

func (_Token *MockToken) InitCommit(opts *bind.TransactOpts) (*bind.CommitResult, error) {
	ret := _Token.Called()
	return ret.Get(0).(*bind.CommitResult), ret.Error(1)
}
